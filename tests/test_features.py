from trade_idea_generator.features import compute_index_features, compute_universe_breadth, trend_stack
...
def test_index_features_have_expected_columns(settings, synthetic_close):
    ...
    assert {"close", "drawdown", "rv20_ann", "rsi14", "ma20", "ma50", "ma200", "range_pos", "roc_20d"}.issubset(features.columns)
